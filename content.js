...
const OB = {
  ...
  valorant: {
    ...
    galleryImgs: [
      { img: 'acheve_1.jpeg', alt: 'Achievement 1' },
      { img: 'acheve_2.jpeg', alt: 'Achievement 2' },
      { img: 'acheve_3.jpeg', alt: 'Achievement 3' },
      { img: 'acheve_4.jpeg', alt: 'Achievement 4' },
      { img: 'acheve_5.jpeg', alt: 'Achievement 5' },
      { img: 'acheve_6.jpeg', alt: 'Achievement 6' },
    ],
  },
  ...
  // ── MERCH STORE ────────────────────────────────────────────
  // Edit this to update the store — players, prices, jersey details, footer text.
  store: {
    playerJerseyPrice: 80,
    teamJerseyPrice: 75,
    sizes: ['S','M','L','XL','2XL'],
    color: 'Blood Black / Red',
    freeShippingOver: 80,
    footerNote: 'Official jerseys for KRIXX, PH4NTM, VOLT, ZER0, RAVEN and NEXUS. Every purchase supports the roster directly.',
    // Jersey detail bullet points (appear in the product accordion)
    jerseyDetails: [
      '100% polyester sublimation print',
      'Tournament moisture-wicking fabric',
      'Old Blood crest on chest',
      'Size up if between sizes',
    ],
    // Team jersey
    teamJersey: {
      bio: 'The team. The org. The lineage.',
      img: 'images/team jersey front.jpeg',
      backImg: 'images/team jersey back.jpeg',
      description: 'The standard Old Blood team jersey. No player name — just the crest, the org, and the blood.',
      details: [
        '100% polyester sublimation print',
        'Tournament moisture-wicking fabric',
        'Old Blood crest on chest',
        'Clean back — no player name',
        'Size up if between sizes',
      ],
    },
    // Roster — add/remove players here to update the whole store
    roster: [
      {
        id: 'krixx',  name: 'KRIXX',  role: 'Duelist',
        bio: 'Entry fragger. First blood every round.',
        accent: '#e8001a', accentDim: '#7a0008',
        img: 'images/krixx.jpeg',
      },
      {
        id: 'ph4ntm', name: 'PH4NTM', role: 'Controller',
        bio: 'Smokes and control. Owns the mid.',
        accent: '#c0003a', accentDim: '#600020',
        img: 'images/ph4ntm.jpeg',
      },
      {
        id: 'volt',   name: 'VOLT',   role: 'Initiator',
        bio: 'Flash entry. Creates space nobody else can.',
        accent: '#e8001a', accentDim: '#7a0008',
        img: 'images/volt.jpeg',
      },
      {
        id: 'zero',   name: 'ZER0',   role: 'Sentinel',
        bio: 'Locks down sites. Nothing gets through.',
        accent: '#c0003a', accentDim: '#600020',
        img: 'images/zero.jpeg',
      },
      {
        id: 'raven',  name: 'RAVEN',  role: 'Duelist',
        bio: 'Lurker. Silent. Deadly.',
        accent: '#e8001a', accentDim: '#7a0008',
        img: 'images/raven.jpeg',
      },
      {
        id: 'nexus',  name: 'NEXUS',  role: 'IGL',
        bio: 'In-game leader. The brain behind Old Blood.',
        accent: '#c0003a', accentDim: '#600020',
        img: 'images/nexus.jpeg',
      },
    ],
  },
